            ...
            public void onClick(View v) {
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Intent browserIntent=new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.google.com/maps/search/police+station/"+"@"+/*Double.toString(longitude)*/30.355039+"/"+/*Double.toString(latitude)*/"76.368345"));
